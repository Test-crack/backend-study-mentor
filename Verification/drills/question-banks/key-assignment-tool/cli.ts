 ...
 *   npm run drills:assign-keys -- --file "path/to/one.csv"
 *
...
async function main(): Promise<number> {
  ...
  program
    ...
    .option('--level <name>', 'Tag one level folder: beginner | intermediate | advanced')
  ...
  console.log(
    needsReview
      ...
      : '  Clean. Next: npm run drills:verify -- --require-source-key --dir <output>',
  );
