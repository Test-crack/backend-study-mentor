/**
 * Types for Layer 2 — the Mock Content Judge.
 *
 * Ported from IA's layer2 types.ts: MockQuestion's row shape spans
 ...
 * none. Severity/outcome vocabulary matches IA's/diagnostic's, not drills':
 * Mock questions are meant to be genuinely discriminating, so TOO_EASY is a
 * real outcome here too.
 *
 * Same audio-transcript limitation as IA: MockQuestion has no
...
import type { MockCsvRow, OptionKey } from '../shared/types';
