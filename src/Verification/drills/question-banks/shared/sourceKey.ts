/**
 * Building and reading a `source_key`.
 *
...
export const SOURCE_KEY_PREFIX = 'drill';
...
/** The bucket part of a key, without the number: `drill_writing_task_response_beginner`. */
export function sourceKeyPrefix(bucket: BucketTriple): string {
  ...
  return `${SOURCE_KEY_PREFIX}_${skill}_${subSkill}_${level}`;
}
