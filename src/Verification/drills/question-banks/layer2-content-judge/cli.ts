 ...
 *
 *   npm run drills:judge                                (every level in drills/)
 *   npm run drills:judge -- --level beginner
 *   npm run drills:judge -- --level beginner --limit 20     (try 20 rows first)
 *   npm run drills:judge -- --file "./a.csv" --votes 3
 *   npm run drills:judge -- --level advanced --no-cache
 *
 * Exit codes:
...
async function main(): Promise<number> {
  ...
  program
    ...
    .option('--level <name>', 'Judge one level folder: beginner | intermediate | advanced')
