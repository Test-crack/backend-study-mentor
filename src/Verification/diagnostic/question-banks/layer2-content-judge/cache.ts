/**
 * Per-question cache, same rationale as drills': re-running after fixing one
 * row shouldn't re-pay for the other nine. One JSON file per source CSV.
 */

import crypto from 'crypto';
import fs from 'fs';
import path from 'path';
import type { DiagnosticCsvRow } from '../shared/types';
...
/** Content-addressed key. Any edit to the question (or its passage/transcript) re-judges only it. */
